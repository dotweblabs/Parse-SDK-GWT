...
public class Parse {
    ...
    public static class Config {
            ...
            Shape.get(Parse.SERVER_URL + "/config")
                    ...
                    .asJson(new AsyncCallback<String>() {
                        ...
                        public void onSuccess(String s) {
                            try {
                                com.parse.gwt.client.Config config = com.parse.gwt.client.Config.fromJSON(s);
        ...
        public static void update(String parameter, JSONValue value, final AsyncCallback<com.parse.gwt.client.Config> callback) {
